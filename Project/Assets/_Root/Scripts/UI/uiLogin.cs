...
namespace UI
{
    public class uiLogin : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            {
                validPassword = NetworkManager.Instance.ValidatePassword(str);
        ...
        {
            if (validUser == false) {
                Debug.LogWarning("Login failed, invalid username");
                return;
            }

            if (validPassword == false) {
                Debug.LogWarning("Login failed, invalid password");
                return;
            }
